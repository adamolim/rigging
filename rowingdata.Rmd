...
stroke_data_00 <- stroke_data0 %>%
    fn_format()

data_sum_0 <- summary_data0 %>%
    fn_format()
...
model_1 <- lm(data = stroke_data_01, speed_imp ~ stroke_rate)
